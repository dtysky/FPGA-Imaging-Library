...
multiplier\_mode: unsigned, The kind of multiplier you want to use.
color\_mode: unsigned, Channels for color, 1 for gray, 3 for rgb, etc.
...
ct\_scale: unsigned, Scale for contrast, fixed, 12bits.12bits.
