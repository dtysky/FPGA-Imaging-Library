vsim -voptargs=+acc -L unisims_ver work.Crop_TB
onerror {resume}
...
add wave -noupdate -radix unsigned /Crop_TB/CPRGBPipeline/in_range_t
add wave -noupdate -radix unsigned /Crop_TB/CPRGBPipeline/in_range_b
add wave -noupdate -radix unsigned /Crop_TB/CPRGBPipeline/in_range_l
add wave -noupdate -radix unsigned /Crop_TB/CPRGBPipeline/in_range_r
...
add wave -noupdate -radix unsigned /Crop_TB/CPRGBReqAck/in_range_t
add wave -noupdate -radix unsigned /Crop_TB/CPRGBReqAck/in_range_b
add wave -noupdate -radix unsigned /Crop_TB/CPRGBReqAck/in_range_l
add wave -noupdate -radix unsigned /Crop_TB/CPRGBReqAck/in_range_r
...
add wave -noupdate -radix unsigned /Crop_TB/CPGrayPipeline/in_range_t
add wave -noupdate -radix unsigned /Crop_TB/CPGrayPipeline/in_range_b
add wave -noupdate -radix unsigned /Crop_TB/CPGrayPipeline/in_range_l
add wave -noupdate -radix unsigned /Crop_TB/CPGrayPipeline/in_range_r
...
add wave -noupdate -radix unsigned /Crop_TB/CPGrayReqAck/in_range_t
add wave -noupdate -radix unsigned /Crop_TB/CPGrayReqAck/in_range_b
add wave -noupdate -radix unsigned /Crop_TB/CPGrayReqAck/in_range_l
add wave -noupdate -radix unsigned /Crop_TB/CPGrayReqAck/in_range_r
